...
class HomeCardsTest extends TestCase
{
    ...
    {
        Card::create([
            'title' => 'Serviço de Imóveis',
            'label' => 'Registro de Imóveis',
            'description' => 'Descrição do serviço.',
            'icon_url' => 'https://example.com/imoveis.png',
            'href' => '#',
            'accent' => 'border-brand-orange',
            'tag_text' => 'text-brand-orange',
            'tag_bg' => 'bg-[#fff8f3]',
        ...
        Card::create([
            ...
            'description' => 'Descrição do serviço.',
            'icon_url' => 'https://example.com/cartorios.png',
            'href' => '#',
        ...
        $allServicesResponse->assertJsonPath('html', fn (string $html): bool => str_contains($html, 'Serviço de Imóveis'));
        $allServicesResponse->assertJsonPath('html', fn (string $html): bool => str_contains($html, 'Serviço de Cartórios'));

        $filteredResponse->assertOk();
        $filteredResponse->assertJsonPath('html', fn (string $html): bool => str_contains($html, 'Serviço de Imóveis'));
        $filteredResponse->assertJsonPath('html', fn (string $html): bool => ! str_contains($html, 'Serviço de Cartórios'));
