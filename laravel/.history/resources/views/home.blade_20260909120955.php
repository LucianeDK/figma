...
@section('content')
    <section id="banner-home" class="relative overflow-hidden bg-[linear-gradient(90deg,_#f2f4f7_0%,_#ffffff_35%,_#ffffff_68%,_#f2f4f7_100%)] shadow-[0_18px_36px_rgba(15,29,54,0.08)] lg:h-[var(--spacing-banner-h)]">
        <div class="absolute inset-y-0 right-40 hidden w-full lg:block">
    ...
    <main class="mx-auto max-w-[1280px] px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <section class="mt-10">
            ...
            <div id="service-cards" data-service-endpoint="{{ route('services.index') }}" class="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                @include('partials.service-cards')
            </div>

            <p id="service-filter-error" class="sr-only" role="alert" aria-live="polite"></p>
        </section>
    </main>
