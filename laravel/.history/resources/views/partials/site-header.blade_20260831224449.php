<header class="bg-brand-navy shadow-[0_4px_14px_rgba(20,61,115,0.15)]">
    <div class="mx-auto flex h-20 max-w-[1280px] items-center justify-between gap-6 px-4 sm:px-6 lg:px-8">
