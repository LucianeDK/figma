...
class HomeCardsTest extends TestCase
{
    ...
    public function test_service_filter_returns_only_the_selected_category_and_hides_removed_category_tab(): void
    {
        ...
        $allServicesResponse->assertJsonPath('html', fn (string $html): bool => str_contains($html, $otherService->title));

        $filteredResponse->assertOk();
        $filteredResponse->assertJsonPath('html', fn (string $html): bool => str_contains($html, $propertyService->title));
        $filteredResponse->assertJsonPath('html', fn (string $html): bool => ! str_contains($html, $otherService->title));
